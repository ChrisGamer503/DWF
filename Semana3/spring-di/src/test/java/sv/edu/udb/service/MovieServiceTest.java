...
class MovieServiceTest {
    ...
    @Test
    void shouldReturnMovieWithCorrectType_When_ValidIdGiven() {
        final Movie movie = movieService.findMovieById(2L);
        assertEquals("Science Fiction Thriller", movie.getType());
    }

    @Test
    void shouldNotReturnNullFields_When_MovieIsFound() {
        final Movie movie = movieService.findMovieById(3L);
        assertAll(
    ...
    @Test
    void shouldReturnDifferentMovies_When_DifferentIdsGiven() {
        final Movie movie1 = movieService.findMovieById(1L);
        final Movie movie2 = movieService.findMovieById(2L);
        assertNotEquals(movie1.getId(), movie2.getId());
        assertNotEquals(movie1.getName(), movie2.getName());
    }
